...
namespace _07._HashTable
{
	internal class Program
	{
		...
		// 하나의 키값을 해싱하는 경우 반드시 항상 같은 결과여야 함(시간에 따라 바뀌면 X)
		// 효율 : 해시의 결과가 분산적일수록 효율이 좋음
		
		// 나눗셈법   : 데이터 % 테이블크기
		// 테이블 크기 : 1000
		// 201 -> 201 / 1121 -> 121 / 338746 -> 746

		// 자리수접기 : 데이터의 각 자리수의 합
		// 201 -> 3 / 1121 -> 5 / 338746 -> 27
		...
		// <해시테이블의 시간복잡도> // 그렇지만 삽입 삭제 전용 자료구조는 아님!! 충돌발생가능성 ↑
		// 접근       탐색       삽입       삭제
		//  X         O(1)       O(1)       O(1)
		...
		static void Main(string[] args)
		{
			...
			// 삭제
			set.Remove("B"); // 있었으면 지우고 true, 없었으면 false
			...
			{
				Console.Write(value);   // output : DBCAE // 정렬까지 보장해주지는 않는다. 그냥 순서대로 출력
			}
			Console.WriteLine();
			...
			// 해시테이블 기반의 Dictionary 자료구조 // 아주아주 중요하다
