namespace _04._Queue
{
	internal class Program
	{
		...
		static void Main(string[] args)
		{
			...
			for (int i = 0; i < 5; i++) // 입력순서 : 0, 1, 2, 3, 4
			{
				queue.Enqueue(i); // 큐에 집어넣기
			}

			Console.WriteLine(queue.Peek()); // 큐의 맨 처음, 다음순서 : 0

			for (int i = 0; i < 3; i++) // 출력순서 : 0, 1, 2
			{
				Console.WriteLine(queue.Dequeue()); // 큐에서 빼기
			}
