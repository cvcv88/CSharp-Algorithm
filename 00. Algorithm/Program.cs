namespace _00._Algorithm
{
	internal class Program
	{
         ...
         * 
         * 문제를 풀기 위한 보편적인 해결 방법들
         * 유튜브 알고리즘, 마케팅 전략
         **********************************************************************************/

		// <알고리즘 조건>
		// 1. 입력 : 알고리즘은 0개 이상의 입력을 가져야 함(입력은 있을수도 없을수도)
		// 2. 출력 : 알고리즘은 최소 1개 이상의 결과를 가져야 함(반드시 있어야 함)
		// 3. 명확성 : 수행 과정은 모호하지 않고 정확한 수단을 제공해야 함(애매X 정확O)
		// 4. 유한성 : 수행 과정은 무한하지 않고 유한한 작업 이후에 정지해야 함(계속 돌아가면 의미가 없음)
		...
		**********************************************************************************************/
         ...
         * 
         * 여러가지 자료구조 알고리즘을 알고, 해당 상황에서 가장 적합한 자료구조 알고리즘을 선택해야 함
         ***************************************************************************/
		...
		// 자원 소모량(돈)에 대한 복잡도는 고려하지 않음.
		// 시간과 공간은 보통 반비례.


		// <Big-O 표기법>
		// 알고리즘의 복잡도를 나타내는 점근표기법
		// 점근표기법 : 대략적으로 표현, 점으로 경향성 표현 / 점근표기법 = 연산횟수
		...
		// 몇개의 자료를 집어넣었을때 늘어나는 성능폭을 보여주는 것이 빅오표기법
		// 가장 높은 차수와 계수만 신경쓰고 나머지는 버리기
		...
		// 최선의 상황은 운좋으면 다 1이다. 사실상 필요없는 수치
